...
pub use crate::wallet::{
    ...
    TransferId, WalletAdjustEvent, WalletCloseEvent, WalletDepositEvent, WalletError, WalletEvent,
    WalletEventDecodeError, WalletFoldError, WalletFreezeEvent, WalletId, WalletLimitEvent,
    WalletOpenEvent, WalletState, WalletTransferEvent, WalletUnfreezeEvent, WalletWithdrawEvent,
